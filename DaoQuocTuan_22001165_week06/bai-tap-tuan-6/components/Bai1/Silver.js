  ...
  return (
    <View style={styles.container}>
      <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
        <Image source={require("../../assets/phonecolor/vs_silver.png")} style={{width: "200px", height: "250px"}}/>
      </View> 
      ...
      <Pressable style={styles.select} onPress={() => navigation.navigate('select', {presentColor: "red"})}>4 MÀU-CHỌN LOẠI</Pressable>
